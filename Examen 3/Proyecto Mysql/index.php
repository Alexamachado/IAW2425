...
<div class="contenedor2">
  <ul>                   <!-- cambiar las direcciones --> 

    <li><a class="secciones" <?php if ($_SESSION['rol'] == "Administrador"){ echo "href='http://3.87.67.53/usuarios.php'"; } else { echo "onclick='invalidar()' href=''" ;} ?> > Gestión de usuarios </a> </li>

    <li><a class="secciones" <?php if ($_SESSION['rol'] == "Administrador"){ echo "href='http://3.87.67.53/departamentos.php'"; } else { echo "onclick='invalidar()' href=''" ;} ?> > Gestión de departamentos </a> </li>

  <li><a class="secciones" <?php if ($_SESSION['rol'] == "Administrador"){ echo "href='http://3.87.67.53/actualiza.php'"; } else { echo "onclick='invalidar()' href=''" ;} ?> > Actualizacion de actividades </a> </li>
 
 <li><a class="secciones" href='http://3.87.67.53/crear.php' > Creación de actividades </a> </li>

  <li> <a class="secciones" <?php if ($_SESSION['rol'] == "Administrador"){ echo "href='http://3.87.67.53/borrado.php'"; } else { echo "onclick='invalidar()' href=''" ;} ?>> Borrado de actividades </a> </li>

  <li><a class="secciones" href='http://3.87.67.53/estadisticas.php' > Estadísticas </a> </li>
  </ul>
